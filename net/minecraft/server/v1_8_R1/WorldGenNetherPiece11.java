...
public class WorldGenNetherPiece11 extends WorldGenNetherPiece {
    ...
    public static WorldGenNetherPiece11 a(List list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
        StructureBoundingBox structureboundingbox = StructureBoundingBox.a(i, j, k, -5, -3, 0, 13, 14, 13, enumdirection);

        return a(structureboundingbox) && StructurePiece.a(list, structureboundingbox) == null ? new WorldGenNetherPiece11(l, random, structureboundingbox, enumdirection) : null;
    }
