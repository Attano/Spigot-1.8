...
public class WorldGenStrongholdCrossing extends WorldGenStrongholdPiece {
    ...
    public static WorldGenStrongholdCrossing a(List list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
        StructureBoundingBox structureboundingbox = StructureBoundingBox.a(i, j, k, -4, -3, 0, 10, 9, 11, enumdirection);

        return a(structureboundingbox) && StructurePiece.a(list, structureboundingbox) == null ? new WorldGenStrongholdCrossing(l, random, structureboundingbox, enumdirection) : null;
    }
